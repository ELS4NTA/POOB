 ...
 * @version 18-03-22
 */
public class Inquieta extends Cell implements Serializable {
	
    private CellularAutomata automata;
    
    /**
     * Constructor for objects of class Inquieta
     * @param ac automata celular
     * @param row entero que indica la fila
     * @param column entero que indica la columna
     */
    ...
    /**
     * Decide el estado de la siguiente celula
     */
    @Override
    public void decide() {
